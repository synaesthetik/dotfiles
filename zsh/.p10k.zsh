...
# sparse, few icons, concise, transient_prompt.
...
() {
  ...
  #typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|terraform'
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
       ...
       '*local*' LOCAL
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEV_FOREGROUND=5
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEV_BACKGROUND=0
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_FOREGROUND=0
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_BACKGROUND=5
  typeset -g POWERLEVEL9K_KUBECONTEXT_BASTION_FOREGROUND=0
  typeset -g POWERLEVEL9K_KUBECONTEXT_BASTION_BACKGROUND=5
  typeset -g POWERLEVEL9K_KUBECONTEXT_LOCAL_FOREGROUND=13
  typeset -g POWERLEVEL9K_KUBECONTEXT_LOCAL_BACKGROUND=0
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      '*prod*'  PROD    # These values are examples that are unlikely
      '*support*'  DEFAULT    # to match your needs. Customize them as needed.
      '*bastion*' BASTION
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND=6
  ...
  typeset -g POWERLEVEL9K_AWS_BASTION_FOREGROUND=8
  typeset -g POWERLEVEL9K_AWS_BASTION_BACKGROUND=7
